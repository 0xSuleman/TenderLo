-- SSGC publishes Active Tenders and their consent-page document links publicly.
-- Keep this source separate from federal aggregators so its primary PDF can be
-- fetched, parsed, and evidenced before a tender row is admitted.
